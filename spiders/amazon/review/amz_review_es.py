                ...
                for asin in file.readlines():
                    ...
                    for page in range(1, 6):
                        self.crawl_with_chrome_cookies(
                            'https://www.amazon.es/product-reviews/%(asin)s/ref=cm_cr_arp_d_viewopt_srt?'
        ...
        for element in response.etree.xpath(".//div[@id='cm_cr-review_list']/div[@data-hook='review']/div"):
            ...
            self.send_message(
                self.project_name,
                {
                    ...
                    'url': 'https://www.amazon.es' + ''.join(element.xpath("div[1]/a[2]/@href")),
                ...
                'https://www.amazon.es' + ''.join(element.xpath("div[1]/a[2]/@href"))
            )
